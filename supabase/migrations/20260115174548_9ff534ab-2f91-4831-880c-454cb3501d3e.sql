CREATE OR REPLACE FUNCTION public.insert_rsvp_with_capacity_check(p_event_id uuid, p_name text, p_email text DEFAULT NULL::text, p_status text DEFAULT 'going'::text, p_plus_ones integer DEFAULT 0, p_dietary_note text DEFAULT NULL::text, p_custom_answers jsonb DEFAULT '{}'::jsonb, p_notifications_enabled boolean DEFAULT true)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
